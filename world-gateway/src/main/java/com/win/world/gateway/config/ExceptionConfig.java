...
import com.win.world.gateway.exception.JsonExceptionHandler;
...
public class ExceptionConfig {
    ...
    public ExceptionConfig(ServerProperties serverProperties, ResourceProperties resourceProperties,
